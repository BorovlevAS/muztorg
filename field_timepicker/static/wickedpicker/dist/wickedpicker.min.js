!(function ($, window, document) {
    ...
    $.extend(Wickedpicker.prototype, {
        showPicker: function (e) {
            typeof this.options.beforeShow === "function" && this.options.beforeShow(e, this.timepicker);
            var t = $(e).offset();
            if (
                ...
                (s.hours = i[0]),
                    (s.minutes = i[2]),
                    this.options.showSeconds ? ((s.seconds = i[4]), (s.meridiem = i[5])) : (s.meridiem = i[3]),
                    this.setTime(s);
            }
            this.timepicker
                .css({
                ...
                .show(),
                typeof this.options.show === "function" && this.options.show(e, this.timepicker),
        ...
        attach: function (e) {
            ...
            var i = function (i) {
                $(t.timepicker).is(":visible") &&
                    ($(i.target).is(t.close)
                        ? t.hideTimepicker(e)
                        : $(i.target).closest(t.timepicker).length || $(i.target).closest($(".hasWickedpicker")).length
                        ? i.stopPropagation()
                        : t.hideTimepicker(e));
            };
        ...
        attachKeyboardEvents: function () {
            $(document).on(
                ...
                $.proxy(function (e) {
                    switch (e.keyCode) {
                        case 9:
                            e.target.className !== "hasWickedpicker" && $(this.close).trigger("click");
                            break;
                        case 27:
