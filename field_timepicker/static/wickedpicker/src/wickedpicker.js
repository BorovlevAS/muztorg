...
(function ($, window, document) {
    ...
    $.extend(Wickedpicker.prototype, {
            ...
            var clickHandler = function (event) {
                ...
                if ($(self.timepicker).is(":visible")) {
                    ...
                    if ($(event.target).is(self.close)) {
                        ...
                        $(event.target).closest(self.timepicker).length ||
                        $(event.target).closest($(".hasWickedpicker")).length
                    ) {
                        ...
                        if (event.type == "mousedown") {
                            timeOut = setInterval(
                                $.proxy(
                                    ...
                                    this,
                                    {Wickedpicker: passedData.Wickedpicker, input: passedData.input}
                                ),
                                200
                            );
                        } else {
        ...
        _time: function () {
            ...
            return inputValue === ""
                ? this.formatTime(this.selectedHour, this.selectedMin, this.selectedMeridiem, this.selectedSec)
                : inputValue;
        },
        _hide: function () {
